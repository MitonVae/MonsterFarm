...
var i18n = {
    ...
    t: function(key, category) {
        ...
        if (category) {
            var sec = dict[category];
            if (sec && sec[key] !== undefined) return sec[key];
            // fallback to zh
            var fb = i18n.translations['zh'][category];
...
zh: {
    ...
    gm: {
        title: '🛠 GM 面板',
        addCoins: '增加金币', addFood: '增加食物',
        addMaterials: '增加材料', addResearch: '增加研究点',
        addMonster: '添加怪兽', unlockTech: '解锁科技',
        harvestAll: '全部收获', close: '关闭面板'
    }
},
...
en: {
    ...
    resources: {
        ...
        research: 'Research', energy: 'Energy'
    },
    settings: {
        title: '⚙️ Settings',
        stats: '📊 Game Stats',
    ...
    gm: {
        title: '🛠 GM Panel',
        addCoins: 'Add Coins', addFood: 'Add Food',
        addMaterials: 'Add Materials', addResearch: 'Add Research',
        addMonster: 'Add Monster', unlockTech: 'Unlock Tech',
        harvestAll: 'Harvest All', close: 'Close Panel'
    }
},
...
ja: {
    ...
    gm: {
        title: '🛠 GMパネル',
        addCoins: 'コイン追加', addFood: '食料追加',
        addMaterials: '素材追加', addResearch: '研究ポイント追加',
        addMonster: 'モンスター追加', unlockTech: 'テクノロジーアンロック',
        harvestAll: '全部収穫', close: 'パネルを閉じる'
    }
}
